...
def installDiversityMod():
	...
	w, h = draw.textsize("Diversity Mod v0.5 Seed",font=smallfont)
	w2, h2 = draw.textsize(str(dmseed.get()),font=largefont)
	draw.text((240-w/2, 213),"Diversity Mod v0.5 Seed",(54,47,45),font=smallfont)
...
# text entry for seed
Label(dmbox, text="Enter seed (case sensitive)",font = "font 14").grid(row=0,pady=10)
